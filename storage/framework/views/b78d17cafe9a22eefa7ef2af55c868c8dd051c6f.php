...
<head>
    ...
    <title>NFT WINDOWS | NFT Marketplace</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('public/main_assets/assets/css/style.css')); ?>">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="<?php echo e(URL::asset('public/main_assets/assets/icon/Favicon.png')); ?>">
    <link rel="apple-touch-icon-precomposed" href="<?php echo e(URL::asset('public/main_assets/assets/icon/Favicon.png')); ?>">
...
<body class="body header-fixed is_dark">
                                ...
                                <div class="wrap-box flex">
                                    <div id="site-logo" class="clearfix">
                                        <div id="site-logo-inner">
                                            <a href="javascript:;" rel="home" class="main-logo">
                                                <img id="logo_header" src="<?php echo e(URL::asset('public/main_assets/assets/images/logo/logo_dark.png')); ?>" alt="nft-gaming" width="133" height="56" data-retina="assets/images/logo/logo_dark@2x.png" data-width="133" data-height="56">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flat-search-btn flex">
                                        ...
                                        <div class="sc-btn-top mg-r-12" id="site-header">
                                            <a href="javascript:;" id="connectbtn" class="sc-button header-slider style style-1 wallet fl-button pri-1"><span>Wallet connect
                                                </span></a>
                                        </div>
                                        ...
                                        <div class="admin_active" id="header_admin">
                                            <div class="header_avatar">
                                                                ...
                                                                <div class="content-inner">
                                                                    <div class="wrap-box">
                                                                        ...
                                                                        <div class="sc-box">
                                                                            <div class="content">
                                                                                <div class="avatar">
                                                                                    <img src="<?php echo e(URL::asset('public/main_assets/assets/images/avatar/avt-6.jpg')); ?>" alt="">
                                                                                </div>
                                                                                <div class="infor">
                                                                                    <span class="fw-7">Lorem Ipsum</span>
                                                ...
                                                <div class="popup-user">
                                                    <img class="avatar" src="<?php echo e(URL::asset('public/main_assets/assets/images/avatar/avt-5.jpg')); ?>" alt="avatar" />
                                                    <div class="avatar_popup mt-20">
                                                        ...
                                                        <div class="links mt-20">
                                                            ...
                                                            <a class="mt-10" href="javascript:;" id="logout">
                                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-12 col-12">
                            <div class="widget widget-logo">
                                <div class="logo-footer" id="logo-footer">
                                    <a href="javascript:;">
                                        <img id="logo_footer" src="<?php echo e(URL::asset('public/main_assets/assets/images/logo/logo_dark.png')); ?>" alt="nft-gaming" width="135" height="56" data-retina="assets/images/logo/logo_dark@2x.png" data-width="135" data-height="56">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-5 col-5">
                            <div class="widget widget-menu style-1">
                                ...
                                <ul>
                                    <li><a href="javascript:;">Authors</a></li>
                                    <li><a href="javascript:;">Collection</a></li>
                                    <li><a href="javascript:;">Author Profile</a></li>
                                    <li><a href="javascript:;">Create Item</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-7 col-7">
                            <div class="widget widget-menu style-2">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:;">Live Auctions</a></li>
                                    <li><a href="javascript:;">Item Details</a></li>
    ...
    <a id="scroll-top"></a>
    <!-- Javascript -->
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/main.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/jquery.easing.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/popper.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/wow.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/plugin.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/count-down.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/shortcodes.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/swiper.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/web3.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/moralis.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/main_assets/assets/js/nft.js')); ?>"></script>

</body>

</html><?php /**PATH D:\xampp\htdocs\troy_laravel\resources\views/mainlayout.blade.php ENDPATH**/ ?>