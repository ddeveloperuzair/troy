...
<style>
    .tf-section.live-auctions.style3.pad-b-54.no-pt-mb.mobie-pb-70 {
    ...
    .is_dark .tab-authors .author-profile {
        background: url("<?php echo e(URL::asset('public/main_assets/assets/images/item-background/bg-authors2.jpg')); ?>") no-repeat center;
    }
</style>

<section class="tf-section authors">
    <div class="themesflat-container">
        <div class="flat-tabs tab-authors" style="margin-top:50px;">
            <div class="author-profile flex">
                ...
                <div class="infor-profile">
                    ...
                    <h2 class="title"> <?php echo e((Auth::user()->name)); ?></h2>
            ...
            <div class="row icon_right">
                <a href="<?php echo e(route('profile')); ?>" target="_parent">
                    ...
                    <div class="row">
                                ...
                                <div class="soft-left">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg width="37" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span class="inner">Category</span> <i class="innner_item">0</i>
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="#">
                                                <div class="sort-filter active">
                                                    <span><img src="<?php echo e(URL::asset('public/main_assets/assets/images/icon/menu.png')); ?>" alt=""> All</span>
                                                    <i class="fal fa-check"></i>
                                                </div>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <div class="sort-filter">
                                                    <span><img src="<?php echo e(URL::asset('public/main_assets/assets/images/icon/rainbow.png')); ?>" alt=""> Art</span>
                                                    <i class="fal fa-check"></i>
                                                </div>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <div class="sort-filter">
                                                    <span><img src="<?php echo e(URL::asset('public/main_assets/assets/images/icon/photo.png')); ?>" alt=""> Photography</span>
                                                    <i class="fal fa-check"></i>
                                                </div>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <div class="sort-filter">
                                                    <span><img src="<?php echo e(URL::asset('public/main_assets/assets/images/icon/itunes.png')); ?>" alt=""> Music</span>
                                                    <i class="fal fa-check"></i>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg width="37" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-md-12">
                            <div class="tf-soft">
                                ...
                                <div class="col-md-12 seclect-box style-1">

                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle b_radius" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg width="37" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5 10H7C9 10 10 9 10 7V5C10 3 9 2 7 2H5C3 2 2 3 2 5V7C2 9 3 10 5 10Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M17 10H19C21 10 22 9 22 7V5C22 3 21 2 19 2H17C15 2 14 3 14 5V7C14 9 15 10 17 10Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M17 22H19C21 22 22 21 22 19V17C22 15 21 14 19 14H17C15 14 14 15 14 17V19C14 21 15 22 17 22Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                            ...
                                            <span class="inner">Filer</span> <i class="innner_item">0</i>
                                        </button>
                                    ...
                                    <div class="dropdown">
                                        <form action="#" id="contactform" novalidate="novalidate">
                                            <input id="name" name="name" tabindex="1" value="" aria-required="true" required="" type="text" placeholder=" Search">
                                    </div>
                                    ...
                                    <div id="all-items" class="dropdown" style="z-index: auto;">
                                        <a href="#" class="btn-selector nolink mycl">Recently Received </a>
                                        <ul style="display: none;" class="">
                                            <li><span>On Auction</span></li>
                                            <li><span>Has Offers</span></li>
                                        </ul>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle  squar_box" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg width="37" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5 10H7C9 10 10 9 10 7V5C10 3 9 2 7 2H5C3 2 2 3 2 5V7C2 9 3 10 5 10Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M17 10H19C21 10 22 9 22 7V5C22 3 21 2 19 2H17C15 2 14 3 14 5V7C14 9 15 10 17 10Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M17 22H19C21 22 22 21 22 19V17C22 15 21 14 19 14H17C15 14 14 15 14 17V19C14 21 15 22 17 22Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6" style="display: block;">
                            <div class="sc-card-product">
                                <div class="card-media">
                                    <a href="javascript:;"><img src="<?php echo e(URL::asset('public/main_assets/assets/images/box-item/card-item-3.jpg')); ?>" alt="Image"></a>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\troy_laravel\resources\views/main_dashboard.blade.php ENDPATH**/ ?>