...
<style>
    ...
    .is_dark .tab-authors .author-profile {
        background: url("{{ URL::asset('public/main_assets/assets/images/item-background/bg-authors2.jpg') }}") no-repeat center;
    }
</style>
        ...
        <div class="flat-tabs tab-authors" style="margin-top:50px;">
            <div class="author-profile flex">
                <div class="feature-profile">
                    ...
                    @php $user_img = Auth::user()->user_img @endphp
                    <img src="{{asset('public/user_img/').'/'.$user_img }}" alt="Image" class="avatar">
                    @else
                    <img src="{{ URL::asset('public/main_assets/assets/images/avatar/Group231.png'); }}" alt="Image" class="avatar">
            ...
            <div class="row icon_right">
                <a href="{{ route('profile') }}" target="_parent">
