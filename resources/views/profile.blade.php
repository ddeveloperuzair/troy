                    ...
                    <ul class="list-unstyled components">
                        <li class="active">
                            <a href="profile.php" target="_parent">
                                <img src="{{ URL::asset('public/main_assets/assets/icon/profile.png'); }}">
                                <span class="sidebar_title"> PROFILE</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('notification_setting') }}" target="_parent">
                                <img src="{{ URL::asset('public/main_assets/assets/icon/notificaion.png'); }}">
                                <span class="sidebar_title"> NOTIFICATIONS</span>
                            </a>
                        </li>
                        <li>
                            <a href="offers.php" target="_parent">
                                <img src="{{ URL::asset('public/main_assets/assets/icon/offers.png'); }}">
                                <span class="sidebar_title"> OFFERS</span>
                            </a>
                        </li>
                        <li>
                            <a href="payment.php" data-toggle="collapse" aria-expanded="false">
                                <img src="{{ URL::asset('public/main_assets/assets/icon/payment.png'); }}">
                        ...
                        <li>
                            <a href="account_support.php" target="_parent">
                                ...
                                <img src="{{ URL::asset('public/main_assets/assets/icon/account.png'); }}">
                        ...
                        <li>
                            <a href="earning.php" target="_parent">
                                ...
                                <img src="{{ URL::asset('public/main_assets/assets/icon/earning.png'); }}">
            ...
            <div class="col-6 left-widgets">
                ...
                <div class="form-upload-profile">
                    ...
                    <div class="option-profile clearfix">
                        <form action="{{ route('custom-info') }}" method="POST" id="contactform" novalidate="novalidate" class="form-profile" enctype="multipart/form-data">
                            @csrf
                            <div class="xyz">
                            ...
                            <div class="image">
                                <label class="uploadFile img">
                                    @if(!empty(Auth::user()->user_banner))
                                    @php $dd = Auth::user()->user_banner @endphp
                                    <img src="{{asset('public/user_banner/').'/'.$dd }}" alt="">
                                    @else
                                    <img src="{{ URL::asset('public/main_assets/assets/images/backgroup-secsion/option1_bg_profile.jpg'); }}" alt="">
                                    @endif
                                </label>
                            </div>
                    </div>
                    ...
                    <div class="form-infor-profile">
                        <div class="info-account">
                            ...
                            <fieldset>
                                ...
                                <input type="text" name="id" value="{{Auth::user()->id}}" required="" hidden>

                                <!-- <input type="text" name="fb"  required="" hidden> -->
                                <input type="text" name="user_name" placeholder="Usaername" value="{{Auth::user()->user_name}}" required="">
                            </fieldset>

                            <fieldset>
                                <textarea tabindex="4" name="bio" rows="5" required="" value="{{Auth::user()->bio}}" placeholder="Bio"></textarea>
                            </fieldset>
                            <fieldset>
                                <input type="text" placeholder="Email Address" value="{{Auth::user()->email}}" required="">
                            </fieldset>
                            ...
                            <!-- <img class="twitter_logo" src="{{ URL::asset('public/main_assets/assets/images/images.png'); }}"> -->
