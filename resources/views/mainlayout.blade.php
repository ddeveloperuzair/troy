...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('public/main_assets/assets/css/style.css'); }}">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="{{ URL::asset('public/main_assets/assets/icon/Favicon.png'); }}">
    <link rel="apple-touch-icon-precomposed" href="{{ URL::asset('public/main_assets/assets/icon/Favicon.png'); }}">
...
<body class="body header-fixed is_dark">
                                    ...
                                    <div id="site-logo" class="clearfix">
                                        <div id="site-logo-inner">
                                            <a href="javascript:;" rel="home" class="main-logo">
                                                <img id="logo_header" src="{{ URL::asset('public/main_assets/assets/images/logo/logo_dark.png'); }}" alt="nft-gaming" width="133" height="56" data-retina="assets/images/logo/logo_dark@2x.png" data-width="133" data-height="56">
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="admin_active" id="header_admin">
                                            <div class="header_avatar">
                                                                ...
                                                                <div class="content-inner">
                                                                    <div class="wrap-box">
                                                                        ...
                                                                        <div class="sc-box">
                                                                            <div class="content">
                                                                                <div class="avatar">
                                                                                    <img src="{{ URL::asset('public/main_assets/assets/images/avatar/avt-6.jpg') }}" alt="">
                                                                                </div>
                                                                                <div class="infor">
                                                ...
                                                <div class="popup-user">
                                                    <img class="avatar" src="{{ URL::asset('public/main_assets/assets/images/avatar/avt-5.jpg') }}" alt="avatar" />
                        ...
                        <div class="col-lg-3 col-md-12 col-12">
                            <div class="widget widget-logo">
                                <div class="logo-footer" id="logo-footer">
                                    <a href="javascript:;">
                                        <img id="logo_footer" src="{{ URL::asset('public/main_assets/assets/images/logo/logo_dark.png') }}" alt="nft-gaming" width="135" height="56" data-retina="assets/images/logo/logo_dark@2x.png" data-width="135" data-height="56">
                                    </a>
                                </div>
    ...
    <a id="scroll-top"></a>
    <!-- Javascript -->
    <script src="{{ URL::asset('public/main_assets/assets/js/jquery.min.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/main.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/jquery.easing.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/popper.min.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/bootstrap.min.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/wow.min.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/plugin.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/count-down.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/shortcodes.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/swiper-bundle.min.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/swiper.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/web3.min.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/moralis.js'); }}"></script>
    <script src="{{ URL::asset('public/main_assets/assets/js/nft.js'); }}"></script>
